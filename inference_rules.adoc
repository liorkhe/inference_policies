...
* The QDL is not allowed to do any pre-processing. i.e. changing of precision, or data layout.
* The QDL is not allowed to do and post-processing of the responses, i.e. gather, reduction, or ArgMax.
...
* The QDL is not allowed to pad of the data in queries.
...
* SUT can do the required pre-processing of the data, i.e batching, Padding, processing of the requests (precision, data layout), compression, decompression. SUT can do the required post processing functions like gather, reduction or ArgMax. 
...
* For reproducibility, it is required to specify software version of all components, HW configurations, software stacks, dockers and settings.

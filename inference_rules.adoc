...
* The QDL is implementing the network function of the LoadGen Node towards the SUT node and handles the required processing. E.G. padding to of the payload to the required network protocol.
